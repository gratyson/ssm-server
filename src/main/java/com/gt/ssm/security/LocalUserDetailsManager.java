...
import com.gt.ssm.model.LocalUser;
...
public class LocalUserDetailsManager implements UserDetailsManager {
    ...
    public void createUser(String username, String password) throws InvalidUserDetailsException {
    ...
    private void validateNewUser(String username, String password) throws InvalidUserDetailsException {
